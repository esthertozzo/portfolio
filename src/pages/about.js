    ...
    <main>
      ...
      <div class="flex flex-col-reverse items-center justify-center xl:px-80 h-auto w-auto mb-20 mt-20 gap-8 xl:flex-row ">
        <div class="flex flex-col gap-4 ">
          <h1 class="text-3xl font-[500] text-(--color-title) ">Sobre <span class = "text-pink-500">mim</span></h1>
    ...
    />
      ...
      <div class = "md:mx-10 lg:mx-10 xl:mx-50 2xl:mx-40 md:p-2 lg:p-6 lg:bg-(--foreground) lg:border lg:border-gray-700 lg:rounded-lg lg:shadow-sm lg:dark:bg-gray-800 lg:dark:border-gray-700">
        ...
        <div class = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-16 justify-items-center">
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-sky-500" src="./typescript.svg" />
          ...
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-indigo-500" src="./react.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-blue-500" src="./ionic.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-red-500" src="./angular.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-pink-500" src="./figma.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-orange-900" src="./mongodb.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-cyan-700" src="./tailwindcss.svg" />
          ...
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-violet-600" src="./bootstrap.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-yellow-400" src="./powerbi.svg" />
          <img class="w-40 h-40 p-0 bg-(--foreground) p-2 pl-8 pr-8 border-3 rounded-[1vw] border-teal-500" src="./python.svg" />
